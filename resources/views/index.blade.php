...
<div>
  ...
  <div> 
   ...
   <span class="form" action="{{ route('store')}}" method="post" >


<div class="animated bounceInDown">
  <div class="container">
    <span class="error animated tada" id="msg"></span>
    <form name="form" class="box"  action="{{ route('store')}}" method="post">
    @csrf
      <h4>Registration<span>Form</span></h4>
      <h5 href="" >Sign in to your account.</h5>
      ...
      <i class="typcn typcn-eye" id="eye"></i>
        ...
        <input  href="" type="submit" value="Sign in" class="btn1">
      </form>
        <a href="/login" class="dnthave">Don’t have an account? Sign up</a>
  </div> 
       <div class="footer">
